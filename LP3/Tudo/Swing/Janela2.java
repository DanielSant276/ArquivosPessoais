...
public class Janela2 extends JFrame implements MouseListener {

	//Construtor que fornece o título da janela
	public Janela2(String title) {
		super(title);
		b3 = new JButton();
		l3 = new JLabel();
		t1 = new JTextField("Vazio");
		l4 = new JLabel("Espaço Vazio");
	}
	...
	public static void main(String[] args) {
		...
		Janela2 minhaJanela = new Janela2("Janela com texto");

		//Seta o layout para uma tabela de 3 linhas e 2 colunas
		minhaJanela.setLayout(new GridLayout(4, 2));
		...
		minhaJanela.t1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				minhaJanela.l3.setText(minhaJanela.t1.getText());
			}
		}
		);

		minhaJanela.t1.addKeyListener(new KeyListener() {
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_F1) {
					minhaJanela.l4.setText("Socorro");
				}
			}
		...
		minhaJanela.add(minhaJanela.t1);
		minhaJanela.add(minhaJanela.l4);
