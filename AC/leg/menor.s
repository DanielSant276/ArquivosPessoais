@ programa para procurar o menor numero de uma lista 11
	
@ define constantes
     
     INTERVALO  .equ 0x0000a  @ tamanho do vetor 10
...
_start:
     ...
     set r4, 0x00      @ posiciona o tamanho do vetor

     set r1, lista     @ 0x300 posicao inicial da memoria
                       @ onde se encontram os numeros da lista de forma sequencial

     ldb r0,  [r1]     @ chute do algoritmo
                       @ o primeiro valor da lista possui o maior valor
                       @ utiliza-se o R0 para guardar o maior valor

     add  r1, 4        @ r1 estara apontando agora para o segunda posição da lista
loop:
     ldb   r3, [r1]    @ carrega em r3 conteudo da memoria apontada por [r1]

     cmp r0 , r3       @ compara os conteudos de R0 e R3
                       @ se o valor de r3 for maior que o valor de r0
     jle nao_troca     @ então o conteudo de r3 deve ser colocado em R0
     mov r0, r3
     set r5, INTERVALO -1
     sub r5, r2        @ subtrai o valor de um com o outro para indicar a posição do                          @ vetor
     mov r4, r5
nao_troca: 
